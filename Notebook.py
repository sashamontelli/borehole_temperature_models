...
def Cell(
    ...
    *,
    ...
    """\
    Helper when working with Jupyter notebook cells by providing the following functionality:

    - Document and enforce dependencies between cells
    - Preserve variables defined within a cell, thereby eliminating global variables across cells
    - Bundling preserved variables in a custom class with an instance named the same as the cell's id

    Usage:
        # Within notebook cell 1...
        with Cell("first_cell", preserve_as_class=True):
            a = 10
            b = 20

        # Within notebook cell 2...
        with Cell("second_cell", dependencies="first_cell", preserve_variables=["c"]):
            c = first_cell.a + 1
            d = first_cell.b + 2

        # Within notebook cell 3...
        with Cell("third_cell", dependencies="second_cell"):
            c += 10   # Good as 'c' was explicitly preserved
            d += 20   # Error, as 'd' was not explicitly preserved
    """
